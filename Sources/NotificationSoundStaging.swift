...
// MARK: - Notification Sound Staging
//
// Sound-transcoding subsystem for custom notification sounds: validates and stages
// user-selected sound files into a location/format usable as a macOS UNNotificationSound
// (transcoding to a supported extension when needed via afconvert), and local playback
// preview support. Extracted from TerminalNotificationStore.swift, which owns the rest of
// notification delivery/state and is a heavy consumer of this settings surface.
