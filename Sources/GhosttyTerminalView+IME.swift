...
// MARK: - GhosttyNSView + IME (NSTextInputClient)
//
// Input Method Editor conformance for GhosttyNSView: marked-text/composition
// state, committed-text delivery, and character-coordinate queries used by
