# Programa terminfo overlay

Programa ships patched `xterm-ghostty` and `xterm-256color` terminfo entries so
...
Programa while preserving Ghostty's truecolor capabilities.
